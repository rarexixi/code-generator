...
请输入命令: """
    ...
    private fun genAggr(tableNameSet: Set<String>, tables: Array<String>) {

        if (tables.isEmpty()) return

        invoke(tableNameSet, tables, false) { tablesToInvoke, tablesNotExist ->
            apply {
                generatorService.genAggr(*tablesToInvoke)
            }
        }
    }
