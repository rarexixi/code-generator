<#if (table.hasUniPk)>
        ...
        enableSelected: function () {
            this.execSelected("确定启用吗？", appConfig.baseApiPath + '/${tablePath}/enable', "启用成功！", "启用失败！");
        },
        disableSelected: function () {
            this.execSelected("确定禁用吗？", appConfig.baseApiPath + '/${tablePath}/disable', "禁用成功！", "禁用失败！");
        },
        </#if>
        delSelected: function () {
            this.execSelected("确定删除吗？", appConfig.baseApiPath + '/${tablePath}/delete', "删除成功！", "删除失败！");
        },
